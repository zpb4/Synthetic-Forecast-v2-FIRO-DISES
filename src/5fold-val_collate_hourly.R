...
syn_hefs_forward<-readRDS(file=paste('out/',loc,'/syn_hefs_forward_hourly_pcnt=',pcnt_opt,'_',keysite_name,'_',cal_val_setup,'-',1,'.rds',sep=''))
...
for(i in 2:5){
  ...
  syn_hefs_fwd<-readRDS(file=paste('out/',loc,'/syn_hefs_forward_hourly_pcnt=',pcnt_opt,'_',keysite_name,'_',cal_val_setup,'-',i,'.rds',sep=''))
...
unlink(paste('out/',loc,'/syn_hefs_forward_hourly_pcnt=',pcnt_opt,'_',keysite_name,'_',cal_val_setup,'-',1:5,'.rds',sep=''),recursive=TRUE)
